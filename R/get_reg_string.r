...
#' @param exclude_user Locical scalar; determines if user defined regressors are included in the 
#'        string of regression names output by the function.
...
#' @export
get_reg_string <- function(seas_obj = NULL, xreg_names = NULL, exclude_user = FALSE) {
    # Author: Brian C. Monsell (OEUS) Version 3.1, 3/12/2025
