...
#' @return A list object of matrices of ACF or PACFs produced for different orders of differncing.
...
#   	written by Brian C. Monsell (OEUS) Version 2.1, 10/23/2024
